...
/**
 * Class referred from WASAPI
 */
public class WaneHttpClient {
  ...
  public WaneHttpClient(WaneProperties settings) throws IOException {
  ...
  private HttpPost createLoginRequest(WaneProperties settings) throws UnsupportedEncodingException {
